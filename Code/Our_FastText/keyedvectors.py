...
class FastTextKeyedVectors(WordEmbeddingsKeyedVectors):
    ...
    def __init__(self, vector_size, min_n, max_n, adaptive):
    ...
    def __contains__(self, word):
        ...
        if word in self.vocab:
            ...
            char_ngrams = _compute_ngrams(word, self.min_n, self.max_n, self.adaptive)
    ...
    def word_vec(self, word, use_norm=False):
        ...
        if word in self.vocab:
            ...
            ngrams = _compute_ngrams(word, self.min_n, self.max_n, self.adaptive)
